...
export const skills: Skill[] = [
  ...
  { name: 'Framer Motion', level: 80, color: '#0055ff', category: 'Frontend' },
  ...
  { name: 'NLP', level: 70, color: '#0066cc', category: 'AI/ML' },
  ...
  { name: 'JWT Auth', level: 82, color: '#000000', category: 'Tools' },
  { name: 'Render', level: 85, color: '#46e3b7', category: 'Deployment' },
  { name: 'Netlify', level: 88, color: '#00c7b7', category: 'Deployment' }
]
