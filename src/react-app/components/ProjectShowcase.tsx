...
const projects: Project[] = [
  ...
  },
  {
    ...
    image: '/mediguardianaipicture.png',
    demoUrl: '#',
    githubUrl: '#',
  ...
  },
  {
    ...
    image: '/detect-fruit-vegetable.png',
    demoUrl: '#',
    githubUrl: '#',
  ...
  },
  {
    ...
    image: '/heavydutyparts-shop.png',
    demoUrl: 'https://heavydutyparts-shop.netlify.app',
    githubUrl: '#',
    highlights: ['WhatsApp Checkout', 'Product Catalog & Search', 'Cloudflare Workers API', 'Responsive Design'],
    color: '#059669'
  }
]
